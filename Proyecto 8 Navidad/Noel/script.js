...
function obtenerTiempoFaltante(fechaLimite){
    ...
    // Calcular los componentes de tiempo (segundos, minutos, horas, días)
    ...
    // Devolver un objeto con los componentes de tiempo
    return {
        segundosFaltantes,
        minutosFaltantes,
        horasFaltantes,
...
function cuentaRegresiva(tiempoFaltante,mensaje){
    ...
    cuentaRegresiva('Nov 21 2023 17:22:00 GMT-0500','Feliz Navidad!');